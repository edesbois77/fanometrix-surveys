-- Migration 040: Visual upgrades to Football as an Access Engine report.
-- Replaces: stat + stat_row → survey_chart (animated bar chart)
-- Replaces: findings_list → pyramid (visual framework)
-- Adds: signals[] to each market_profile (intelligence cards)
...
[
  ...
  },
  {
    ...
    "items": [
      ...
      { "label": "Rewards and discounts",                       "value": 18 },
      { "label": "Fan events and watch parties",                "value": 7  },
      { "label": "Exclusive content and insights",              "value": 5  }
    ]
  },
  {
    "type": "pull_quote",
