...
export const NAV_ITEMS: NavItemConfig[] = [
  ...
  },
  {
    ...
    icon: "▤",
    description: "Upload, review and search reusable documents — industry reports, case studies, benchmarks and more — attachable to any Research Project.",
  ...
  },
  {
    ...
    icon: "✦",
    description: "A guided, step-by-step demonstration of how Fanometrix works, for sales and onboarding, clearly labelled, never real client data.",
    cta: "Open Product Walkthrough",
    section: "platform",
    roles: ["admin", "brand", "agency", "publisher"],
    navGroup: "surveys",
  },
  ...
  },
  {
    ...
    label: "Organisations",
    icon: "◎",
    description: "Manage publishers, agencies, brands and internal teams, the registry every user and campaign links back to.",
