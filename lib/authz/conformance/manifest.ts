...
export const CONFORMANCE_MANIFEST: ConformanceItem[] = [
  ...
  { ref: "Q-29-activate", cls: "TARGET", description: "Audit subsystem LIVE: migration 168 applied; mandatory events recorded live at their sources; SG-7 fail-closed live; tamper-evidence + G9 read-consistency verified in production.", closesAt: "IW-7-activation", evidence: ["lib/authz/conformance/invariants.test.ts"] },
