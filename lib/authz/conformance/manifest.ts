...
export const CONFORMANCE_MANIFEST: ConformanceItem[] = [
  ...
  { ref: "Q-14/Q-15-activate", cls: "TARGET", description: "Resource Entitlement LIVE: migration 170 applied; user_access_grants→User Resource Authorisation + ownership-FK→Org Entitlement (as Policy Input) dual-run; enforced at the seam (SG-6). §38 concrete scope schemas reserved.", closesAt: "IW-6-activation", evidence: ["lib/authz/conformance/invariants.test.ts"] },
