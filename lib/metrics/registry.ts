...
const DEFINITIONS: MetricDefinition[] = [
  // ── Exposure ────────────────────────────────────────────────────────────
  {
    id: "survey_renders",
    name: "Survey Renders",
    definition: "The number of times the survey creative rendered into the user's viewport — a Fanometrix-measured opportunity to engage. Not the same as a publisher ad-server impression, reach or frequency.",
    formula: "Count of SURVEY_RENDER events",
    whyItMatters: "Represents the total number of opportunities for respondents to engage with the survey.",
    format: "integer",
    domain: "surveys",
  ...
  },
  {
    id: "q1_answer_rate",
    name: "Q1 Answer Rate",
    definition: "The share of survey renders that resulted in a first answer.",
    formula: "Q1 Answered ÷ Survey Renders",
  ...
  },
  {
    ...
    definition: "The share of survey renders that resulted in a completed response — the end-to-end conversion through the whole survey funnel.",
    formula: "Completed Responses ÷ Survey Renders",
