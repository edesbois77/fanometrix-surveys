-- Migration 041: Reposition "Fan Expectation Gap" as "The Emerging Fan Value Gap".
-- Removes the 44% survey chart and replaces with an editorial anchor insight,
-- four strategic insight cards and a methodology note.
-- The section now reads as directional intelligence, not definitive market data.
...
[
  ...
  {
    "type": "chapter_break",
    "number": "THE ANCHOR INSIGHT",
    "label": "The Emerging Fan Value Gap",
    "description": "Early Fanometrix testing and wider industry analysis point towards the same conclusion: fans increasingly value brands that improve football rather than simply advertise within it."
  },
  {
    "type": "insight_section",
    "headline": "Grassroots and community investment emerged as the strongest signal of brand value",
    "narrative": "In early Fanometrix testing, support for grassroots football and local communities ranked ahead of rewards, content and fan events when respondents were asked what makes a brand feel genuinely committed to football. While the sample remains directional, the finding aligns strongly with broader market evidence reviewed across the five markets."
  },
  {
    "type": "insight_cards",
    "cards": [
      {
        "title": "Grassroots creates credibility",
        "body": "Fans distinguish between brands that sponsor football and brands that invest in football."
      },
      {
        "title": "Experiences outperform rewards",
        "body": "Access to matches, players and unique experiences typically generates stronger fan value than transactional benefits."
      },
      {
        "title": "Visibility alone is no longer enough",
        "body": "Sponsorship visibility remains important, but increasingly needs to be linked to a tangible fan benefit."
      },
      {
        "title": "Contribution drives perception",
        "body": "Fans reward brands that improve access, participation or community value within football."
      }
    ],
    "note": "Insight informed by early Fanometrix testing, Football365 audience polling and supporting industry research. Findings should be treated as directional indicators rather than nationally representative market data."
  },
  {
    "type": "pull_quote",
  ...
  },
  {
    ...
    "signals": [
      { "label": "Friction Index",          "value": "HIGH" },
      { "label": "Matchday cost concern",   "value": "↑ Rising" },
      { "label": "Streaming fragmentation", "value": "#1 Pain Point" }
    ],
  ...
  },
  {
    ...
    "signals": [
      { "label": "Community Trust Score", "value": "VERY HIGH" },
      { "label": "Grassroots importance", "value": "#1 Priority" },
      { "label": "50+1 rule sentiment",   "value": "Deeply Held" }
    ],
  ...
  },
  {
    ...
    "stat": "79%",
    "stat_label": "identify football as important to national culture",
    "signals": [
      { "label": "Participation culture",    "value": "VERY HIGH" },
      { "label": "Local football support",   "value": "Top Driver" },
      { "label": "Women's football index",   "value": "↑ Growing" }
    ],
  ...
  },
  {
    ...
    "signals": [
      { "label": "Growth opportunity",  "value": "VERY HIGH" },
      { "label": "Youth audience",      "value": "Under 30" },
      { "label": "Digital fandom",      "value": "Social-first" }
    ],
  ...
  },
  {
    ...
    "signals": [
      { "label": "Digital fandom index",      "value": "VERY HIGH" },
      { "label": "Player access demand",      "value": "#1 Priority" },
      { "label": "Social platform dominance", "value": "WeChat/Weibo" }
    ],
  ...
  {
    "type": "pyramid",
    "title": "The Fanometrix Access Pyramid",
    "subtitle": "Sponsorship becomes more valuable as brands move up the pyramid",
    "levels": [
      { "number": 5, "label": "Legacy",        "sublabel": "ACCESS TO LEGACY",        "description": "Brands contribute to the long-term health and growth of football. Investment at this level builds generational brand equity. The most admired football sponsors operate here." },
      { "number": 4, "label": "Participation", "sublabel": "ACCESS TO PARTICIPATION", "description": "Fans and future fans can play and participate. Grassroots investment, youth football and facility funding operate here. This is where brand perception permanently shifts." },
      { "number": 3, "label": "Communities",   "sublabel": "ACCESS TO COMMUNITIES",   "description": "Fans can connect with other fans, locally and globally. Brands that create community infrastructure — digital or physical — build longer-term brand equity." },
      { "number": 2, "label": "Experiences",   "sublabel": "ACCESS TO EXPERIENCES",   "description": "Fans can attend, participate in, or get closer to football experiences. Brand presence is visible but still transactional." },
      { "number": 1, "label": "Content",       "sublabel": "ACCESS TO CONTENT",       "description": "Fans can watch, follow and engage with the football they care about. Brands that remove barriers to content access earn broad positive sentiment." }
    ]
  },
  {
    "type": "insight_section",
  ...
  },
  {
    "type": "download_cta",
    "headline": "Football as an Access Engine",
    "description": "Download the full report and supporting assets to share with your team.",
    "primary_label": "Download Full Report",
    "primary_url": "",
    "secondary_label": "Download Executive Summary",
    "secondary_url": ""
  },
  {
    "type": "methodology",
