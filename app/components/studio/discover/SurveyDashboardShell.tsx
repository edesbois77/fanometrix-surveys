    ...
    <>
      ...
      <div className="mt-6">
        {view === "performance" ? (
          ...
          isPreview ? (
            previewFindings ? (
              <SurveyFindingsView findings={previewFindings.findings} context={previewFindings.context} answers={previewFindings.counts.answers} mode={previewFindings.mode} analysis={previewFindings.analysis} canGenerate={previewFindings.canGenerate} onAnalyse={() => {}} onViewResults={() => changeView("results")} />
            ...
            <SurveyFindingsView findings={liveFindings.data.findings} context={liveFindings.data.context} answers={liveFindings.data.counts.answers} mode={liveFindings.data.mode} analysis={liveFindings.data.analysis} canGenerate={liveFindings.data.canGenerate} analyseBusy={analysisBusy} onAnalyse={generateAnalysis} onViewResults={() => changeView("results")} />
          )
        ) : isPreview ? (
