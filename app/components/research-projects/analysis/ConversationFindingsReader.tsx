...
// Shared, CHROMELESS Conversation Findings reader. Extracted from the original
// reports/conversation/[evidenceId] page so the identical reader mounts in two
// hosts: reports/conversation/[evidenceId] (AdminShell; Product Walkthrough
// re-exports it, unchanged) and (workspace)/analysis/conversation/[evidenceId]
// (Research Project workspace shell). Review logic, engines, approval workflow
// and stored outputs are untouched — only the surrounding chrome is host-supplied.
...
export function ConversationFindingsReader() {
