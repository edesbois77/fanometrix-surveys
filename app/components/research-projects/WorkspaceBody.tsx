...
import { SimulationInformationPanel, type SimulationInfo } from "@/app/components/simulation/SimulationInformationPanel";
...
import { CampaignGroupsSection, type CampaignGroupSummary } from "@/app/components/research-projects/CampaignGroupsSection";
import { getWorkspaceScrollTarget, clearWorkspaceScrollTarget } from "@/lib/workspace-scroll";

type ActivityRow = { id: string; event_type: string; description: string; actor: string | null; created_at: string };

type ConversationSearchEvidence = {
...
export function WorkspaceBody({ projectId: id, presentModeEnabled }: { projectId: string; presentModeEnabled: boolean }) {
  const router = useRouter();
