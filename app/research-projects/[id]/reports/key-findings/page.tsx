...
// Key Findings' own page — sibling of ../executive/page.tsx and
// ../survey/[evidenceId]/page.tsx, same reasons: a "Back to Workspace"
// destination rather than a pop-up. Project-level like Executive Report
// (no per-source id) — a flat, downloadable list of plain stat facts across
...
// crash this page, degrade to showing the raw value instead. Regenerate
// always produces current, valid values; only a stale saved row could hit
// this fallback.
...
export default function KeyFindingsPage() {
  ...
  // Skips the "Generate Key Findings" click when the source's own button
  // already said "Generate Key Findings →" — the page fires generation
