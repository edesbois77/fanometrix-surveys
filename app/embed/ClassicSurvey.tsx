...
// Self-contained production classic survey creative (plain radio-button
// list, no imports from /creative-lab/). Rendered by app/embed/page.tsx
// whenever the resolved creative_design has layout "classic" — this is the
// design formerly served implicitly whenever no theme was chosen; it is
// now the "Fanometrix Default" entry in lib/creative-designs.ts so it can
// be picked explicitly (project default, or a deployment override even
// when its project defaults to a themed design).
//
// Owns its own event tracking (SURVEY_RENDER/START/COMPLETED/EXIT) and
// submit call, mirroring ThemedSurvey.tsx's self-contained pattern —
