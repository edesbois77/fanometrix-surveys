// Marks a Research Project's Editorial Article as approved — the admin's
...
// approving an already-approved article is a harmless no-op. Not allowed
...
export async function POST(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  await logActivity(id, "article_approved", "Editorial Article approved", session.workEmail);
