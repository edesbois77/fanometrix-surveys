// Saves an admin's edits to a Survey's research summary. Structural
// mirror of app/api/social/insights/edit/route.ts. The original AI draft
// (research_summaries.content) is never touched — edits always land in
// edited_content, and status moves to "edited".
