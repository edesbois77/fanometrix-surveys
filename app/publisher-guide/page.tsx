...
// ─── Partner logo flag ────────────────────────────────────────────────────────
// Set to true once logo usage permissions have been obtained from each partner.
// When false: styled text placeholders are shown instead.
const SHOW_PARTNER_LOGOS = false;

const PARTNERS: { name: string; slug: string }[] = [
  { name: "FotMob",           slug: "fotmob"           },
  { name: "LiveScore",        slug: "livescore"        },
  { name: "Forza Football",   slug: "forza-football"   },
  { name: "Football365",      slug: "football365"      },
  { name: "Flashscore",       slug: "flashscore"       },
    ...
    <div style={{ fontFamily: "system-ui, -apple-system, sans-serif", minHeight: "100vh", background: "#fff" }}>
      ...
      <section style={{ background: "#F9FAFB", padding: "64px 24px" }}>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", textAlign: "center" }}>
          <p style={{ fontSize: 13, fontWeight: 600, color: "#9CA3AF", marginBottom: 6, letterSpacing: "0.02em" }}>
            Trusted by football publishers and media partners
          </p>
          <p style={{ fontSize: 14, color: "#B0B7C3", marginBottom: 48, lineHeight: 1.6 }}>
            Built to work seamlessly within premium football media environments.
          </p>
          ...
          <div style={{
            ...
            {PARTNERS.map(({ name, slug }) => (
              <div key={slug} className="fm-logo-item">
                {SHOW_PARTNER_LOGOS ? (
                  /* ── Real logo (activate once permissions obtained) ── */
                  // eslint-disable-next-line @next/next/no-img-element
                  <img
                    src={`/logos/partners/${slug}.svg`}
                    alt={name}
          ...
          {/* Divider */}
          <div style={{ marginTop: 56, height: 1, background: "#E5E7EB", maxWidth: 600, margin: "56px auto 0" }} />
        </div>
      </section>
