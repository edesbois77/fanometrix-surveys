            ...
            <div>
              ...
              <ul className="space-y-1.5">
                {[
                  ...
                  "Approx. 1,800 responses",
                  "LiveScore publisher audiences",
        ...
        <div className="border-t pt-10" style={{ borderColor: "rgba(255,255,255,0.08)" }}>
          ...
          <div className="space-y-3">
            {[
              ...
              "Survey respondents were predominantly UK football fans, with smaller samples from Germany and Sweden.",
              "Market-specific recommendations for India and China are based primarily on secondary research and market intelligence rather than direct survey responses.",
            ].map((note, i) => (
